...
// Hex below is the result of `WorldResourceIdLib.encode({ namespace: "kalb_v22", name: "ItemSellerERC20", typeId: RESOURCE_TABLE });`
ResourceId constant _tableId = ResourceId.wrap(0x74626b616c625f7632320000000000004974656d53656c6c6572455243323000);
