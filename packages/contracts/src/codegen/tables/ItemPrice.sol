...
// Hex below is the result of `WorldResourceIdLib.encode({ namespace: "kalb_v22", name: "ItemPrice", typeId: RESOURCE_TABLE });`
ResourceId constant _tableId = ResourceId.wrap(0x74626b616c625f7632320000000000004974656d507269636500000000000000);
